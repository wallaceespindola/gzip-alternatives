...
public enum SerializationType {
    ...
    public static final EnumSet<SerializationType> QUICK_TYPES_AND_GZIP = EnumSet.of(GZIP_STANDARD, LZ4_ORG_BLOCK, LZ4_ORG_FRAME, GZIP_PARALLEL, BROTLI_COMPRESSOR_BROTLI4J_Q2);
    ...
    public static final EnumSet<SerializationType> BROTLI_FAST_TYPES = EnumSet.of(BROTLI_COMPRESSOR_BROTLI4J_Q2, BROTLI_COMPRESSOR_BROTLI4J_Q4);
