 ...
 * @author shevek
 */
public class MyParallelGZIPOutputStream extends FilterOutputStream {
    ...
    public MyParallelGZIPOutputStream(@Nonnull OutputStream out, @Nonnull ExecutorService executor, @Nonnegative int nthreads) throws IOException {
        super(out);
     ...
     */
    @Deprecated // Doesn't really use the given number of threads.
    public MyParallelGZIPOutputStream(@Nonnull OutputStream out, @Nonnegative int nthreads) throws IOException {
        this(out, ParallelGZIPEnvironment.getSharedThreadPool(), nthreads);
    }

    public MyParallelGZIPOutputStream(@Nonnull OutputStream out, @Nonnull ExecutorService executor) throws IOException {
     ...
     * @throws IOException if it all goes wrong.
     */
    public MyParallelGZIPOutputStream(@Nonnull OutputStream out) throws IOException {
